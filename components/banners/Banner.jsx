...
const Banner = () => {
  return (
    <div className="flex flex-col xl:flex-row justify-center px-[3vw] w-full h-screen relative border-b border-gray-200">
      <div className="flex w-full h-screen relative">
        <div className="flex flex-col justify-center font-macklindisplay">
          ...
          <button className="items-center space-x-[1vw] hidden sm:flex w-fit ml-[24vw] mt-[7vh]">
        ...
        <div className="absolute right-[0vw] top-[5vw]">
          <Image
            src="/bannerimg.png"
